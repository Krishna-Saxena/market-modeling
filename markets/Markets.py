...
from modeling_utils.py_utils import apply_one_encode, apply_many_encode, last_index_lt_1D
from modeling_utils.xr_utils import ffill_via_pandas, bfill_via_pandas, zeros_like_nan, get_dataset_only_numeric_vars
...
class Market:
  ...
  def display_market(self, **kwargs):
    ...
    fig.colorbar(cbar, ax=ax, shrink=0.5, aspect=10, pad=0.1, label='', alpha=0.5)
  ...
  def train_test_split(self, val_size=0.1, test_size=0.2):
    """
